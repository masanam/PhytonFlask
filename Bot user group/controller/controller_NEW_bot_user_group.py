...
from model_NEW_bot_user_group import DataList
...
class NewController():
    def new_controller():
        ...
        return render_template('tmpl_NEW_bot_user_group.html', title='New Bot user group',listdata_tv=result_tv, listdata=result, countdata=count)    
    ...
    def insert_controller():
        ...
        count = DataList.count_data()
        return render_template('tmpl_NEW_bot_user_group.html', title='New Bot user group', listdata=result, countdata=count)      
    ...
    def clone_controller():
        ...
        count = DataList.count_data()
        return render_template('tmpl_NEW_bot_user_group.html', title='New Bot user group', listdata_tv=result_tv, listdataL=resultL, countdata=count, countL=countL)              