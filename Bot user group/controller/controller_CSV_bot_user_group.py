...
from model_CSV_bot_user_group import DataCSV
...
class CSVController():
    def CSV_controller():
        ...
        if request.form.get('Btn_save'):
            ...
            return render_template('tmpl_CSV_bot_user_group.html', title='CSV Bot user group',csvdata=result,countdata=count,filepath=filename,csvrow=row_count)       