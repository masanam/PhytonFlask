...
from model_CSV_task_value import DataCSV
...
class CSVController():
    def CSV_controller():
        ...
        if request.form.get('Btn_save'):
            ...
            return render_template('tmpl_CSV_task_value.html', title='CSV Task value',csvdata=result,countdata=count,filepath=filename,csvrow=row_count)       