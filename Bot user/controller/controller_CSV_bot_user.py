...
from model_CSV_bot_user import DataCSV
...
class CSVController():
    def CSV_controller():
        ...
        if request.form.get('Btn_save'):
            ...
            return render_template('tmpl_CSV_bot_user.html', title='CSV Bot user',csvdata=result,countdata=count,filepath=filename,csvrow=row_count)       