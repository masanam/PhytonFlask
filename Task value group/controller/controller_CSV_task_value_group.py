...
from model_CSV_task_value_group import DataCSV
...
class CSVController():
    def CSV_controller():
        ...
        if request.form.get('Btn_save'):
            ...
            return render_template('tmpl_CSV_task_value_group.html', title='CSV Task value group',csvdata=result,countdata=count,filepath=filename,csvrow=row_count)       